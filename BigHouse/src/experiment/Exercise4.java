...
public class Exercise4 {
    ...
    public void run(String workloadDir, String workload, String schedulerType, String priorityPolicy) {
        ...
        Experiment experiment = new Experiment("Exercise 4", rand, experimentInput, experimentOutput);
        ...
        for(int i = 0; i < nServers; i++) {
            ...
            server.setSocketPolicy(SocketPowerPolicy.SOCKET_PARKING);
            ...
            server.setScheduler(schedulerType);
            server.setPriority(priorityPolicy);
    ...
    public static void main(String[] args) {
        Exercise4 exp  = new Exercise4();
        if (args.length >= 4) {
            exp.run(args[0], args[1], args[2], args[3]);
        } else {
            exp.run(args[0], args[1], args[2], "NO_PRIORITY");
        }
    }
