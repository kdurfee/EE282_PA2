...
public class Exercise1 {
    ...
    public void run(String workloadDir, String workload, int nServers, double dvfs) {
        ...
        Experiment experiment = new Experiment("Exercise 1", rand, experimentInput, experimentOutput);
